      ...
      >
        ...
        <div className="relative hidden md:flex flex-col items-center justify-center p-8 bg-gray-50 dark:bg-black/20">
          ...
          <p className="relative z-10 mt-4 text-center text-lg text-gray-600 dark:text-white/80">
            Your personal wellness companion. A safe space, just for you.
          </p>
        </div>
        ...
        <div className="p-8 md:p-12">
          ...
          <motion.form 
            ...
            animate="visible"
          >
            <motion.div variants={formVariants}><InputField id="name" label="Your Name" value={name} onChange={(e) => setName(e.target.value)} icon={FaUser} /></motion.div>
            ...
            <motion.div variants={formVariants}><InputField id="confirmPassword" label="Confirm Password" type="password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} icon={FaLock} /></motion.div>
          ...
          <p className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
            Already have an account? <Link to="/login" className="font-medium text-calm-blue hover:underline">Log In</Link>
          </p>
        </div>
      </motion.div>
    </div>
